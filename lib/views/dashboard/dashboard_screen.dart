                ...
                child: Scaffold(
                    ...
                    Align(
                      ...
                      child: iUtills().upperRoundedContainer(
                        context, screenWidth, screenHeight * 0.476,
                          ...
                          InkWell(
                              onTap: () async {
                                ...
                                if (!status.isGranted) {
                                  print('dialoge open...');
                                  vm.permissionCheck(
                                      parentContext, osVersion, status);
                                } else {
                                  if (vm.queue.isEmpty) {
                                    Navigator.pushNamed(parentContext!,
                                        FileManagerHome.routeName);
                                  }
                                  else {
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.pushNamed(
                                context, CloudItemsScreen.routeName);
                          },
                          child: customTile(icon: AppConstants.restore_icon,
                              title: "Restore Files"),
                        ),
                        ],
                      ),
