            ...
            child: vm.videos.isEmpty
                ...
                : Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: AssetImage('assets/images/container_background.webp'), fit: BoxFit.cover),
                        ...
                        Expanded(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                onPressed: () {
                                  vm.isAllVideosSelected = !vm.isAllVideosSelected;
                                  !vm.isAllVideosSelected ? vm.unselectAllInList(vm.videos) : vm.selectAllInList(vm.videos);
                                },
                                icon: Icon(
                                  vm.isAllVideosSelected ? Icons.check_box_outlined : Icons.check_box_outline_blank,
                              ...
                              children: [
                                ListView.builder(
                                  ...
                                  itemBuilder: (
                                    ...
                                    return InkWell(
                                      onTap: () {
                                        vm.videos[index].isSelected = !vm.videos[index].isSelected;
                                        if (vm.videos[index].isSelected) {
                                          vm.addToSelectedList = vm.videos[index];
                                        } else {
                                          vm.removeFromSelectedList = vm.videos[index];
                                        }
                                      },
                                      child: cloudFileCard(
                                          context: context,
                                          ...
                                          isSelected: vm.videos[index].isSelected),
                                    );
                                  },
