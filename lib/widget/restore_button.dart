...
import '../file_manager/constants/app_colors.dart';
class RestoreButton extends StatelessWidget {
  ...
  RestoreButton({required this.text,required this.onTap,required this.width,required this.padding,required this.btnColor});
  @override
